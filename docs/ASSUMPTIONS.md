...
- Browser E2E tests use Playwright with Chromium, a local Uvicorn server on `127.0.0.1:8000`, role/label/text locators, deterministic API results, and bounded Playwright assertions. Four browser tests currently pass; persistence, authentication, deployment, and production hardening remain planned.
