...
- The reproducibility boundary is the complete JSON request plus fixed CP-SAT settings (`num_search_workers=1`, `random_seed=40`); identical requests must produce identical JSON. Persistence, file upload, authentication, UI, and deployment remain planned.
