...
\midrule
0.1.0 & 2026-09-21 & Initial technical report for the previous baseline/economics revision, commit \texttt{95ca2cf}.\\
...
Breaks, skills, absences, payroll integration, persistence, API, UI, deployment, and configurable shift rules are \planned. Explicit peak coverage, overtime economics, and configurable objective weights are implemented in this work unit.
...
The repository test suite contains eighteen tests, and the observed result for this work unit is:
\begin{verbatim}
.venv/bin/pytest -q
................                                                         [100%]
\end{verbatim}
...
pdflatex -interaction=nonstopmode -halt-on-error \
  -output-directory /tmp/almond-latex docs/ALMOND_TECHNICAL_REPORT.tex
\end{verbatim}
The second LaTeX pass resolves references. The expected PDF is \texttt{/tmp/almond-latex/ALMOND\_TECHNICAL\_REPORT.pdf}. This report documents commit \texttt{aa457d2}; later code changes require re-running both the demo and the report's metric claims.
...
Exact implementation revision & Git commit \texttt{aa457d2}.\\
\bottomrule
\end{longtable}
...
\begin{enumerate}
  \item \texttt{README.md}, Almond repository, commit \texttt{aa457d2}.
  \item \texttt{docs/ARCHITECTURE.md}, Almond repository, commit \texttt{aa457d2}.
  \item \texttt{docs/SOLVER\_MODEL.md}, Almond repository, commit \texttt{aa457d2}.
  \item \texttt{docs/DATA\_MODEL.md} and \texttt{docs/ASSUMPTIONS.md}, Almond repository, commit \texttt{aa457d2}.
  \item \texttt{docs/AI\_ENGINEERING\_LOG.md}, Almond repository, commit \texttt{aa457d2}.
  \item \texttt{src/almond/} and \texttt{tests/test\_engine.py}, Almond repository, commit \texttt{aa457d2}.
\end{enumerate}
